...
export const metadata: Metadata = {
  ...
  description:
    "Explore Jashanpreet Singh's portfolio – a skilled Frontend Developer specializing in MERN Stack, React, and modern web technologies. Showcasing innovative projects, UI/UX expertise, and high-performance web applications.",
  keywords: [
    "Frontend Developer",
    "Next.js Developer",
    "React Developer",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jashanpreet Singh - Frontend Developer Portfolio",
      },
    ],
  },
  twitter: {
    ...
    title: "Jashanpreet Singh | Frontend Developer Portfolio",
    description:
      "Explore Jashanpreet Singh's frontend projects and expertise in React, MERN Stack, and modern web development.",
    images: [
