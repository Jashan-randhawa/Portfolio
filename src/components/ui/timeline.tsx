    ...
    <div className="w-full md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-3xl italic">
          I started my journey at JMIT Radaur as engineering Student  and spent 4 year building interset in web development. For the past 4 years, I&#39;ve been growing at
          JMIT — and the journey continues. <br /> Here&apos;s a
