...
Developed strong interest in web development, mastering HTML, CSS, JavaScript, and PHP while strengthening my computer science foundation through data structures and algorithms.
  ...
  {
    title: "2025 Btech Fourth Year",
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-4">
         Embarked on a new chapter building cutting-edge AI with <strong>Digital Fortress</strong>.<br />
Now, as a final-year BTech (IT) student, I design AI agents and integrate them into real websites (APIs, webhooks, RAG) to automate user workflows.<br />
Step by step, I earned trust as a key contributor—shipping features end-to-end and hardening product stability.
        </p>
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-8">
          ...
          results across key AI projects. Here are some of the milestones I’m
          most proud of:
        </p>

        <div className="mb-8">
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Delivered multiple AI-focused web apps from development to
            production
          </div>
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
          ...
          <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            ✅ Enhance Data Structure and Algorithms knowledge
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <BlurImage
